...
<center>
    ...
    <form method="GET" action="product_browse.php">
        ...
        <a href="product_browse.php"><button type="button">Reset</button></a>
    </form>

    <br>
    <div class="categories">
        Filter: 
        <a href="product_browse.php?type=Mobile">Mobile</a> | 
        <a href="product_browse.php?type=Computer">Computer</a> | 
        <a href="product_browse.php?type=Gadget">Gadget</a>
    </div>
    <br>
