...
<div class="main-container">
    ...
    <div class="content-area">
        ...
        <div class="offers-box" style="text-align: left; background: #e9ecef; border: none;">
            <form method="GET" action="customerDashboard.php" style="display: flex; gap: 10px;">
                ...
                <?php if(isset($_GET['search'])) { ?>
                    <a href="customerDashboard.php"><button type="button" style="padding: 10px 20px; background: #dc3545; color: white; border: none; cursor: pointer; border-radius: 5px;">Reset</button></a>
                <?php } ?>
            </form>
        </div>
        ...
        <div class="products-box">
            ...
            ?>
                <div class="product-card" data-type="<?= strtolower($row['type']); ?>">
                    ...
                    <form method="POST" action="../controllers/cartController.php" style="margin-top:5px;">
